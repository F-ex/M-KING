	...
	while True:
		...
		if choix.lower() == 'h':
			...
			while True:
				...
				choix = input("\n M-KING("+Fore.BLUE + "Profiler" + Fore.RESET + ")$ ")
			...
			print(lookupOption)
			while True:
				lookup = input("\n M-KING("+Fore.BLUE+"Lookup"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if lookup == 'h':
					print(helpLookup)
				elif lookup.lower() == '1':
			...
			while True:
				se = input("\n M-KING("+Fore.BLUE+"OtherTool"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if se == 'h':
					print(helpOtherTool)
				elif se == "1":
					hashdecrypt()
			...
			while True:
				newCode = input("\n M-KING("+Fore.BLUE+"Country"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if newCode == '1':
